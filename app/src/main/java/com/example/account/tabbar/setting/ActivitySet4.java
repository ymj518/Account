...
public class ActivitySet4 extends AppCompatActivity implements View.OnClickListener{
    ...
    public class MyBaseAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) { //获取item的view视图
            ...
            View view = View.inflate(ActivitySet4.this,R.layout.activity_list_item3,null);
